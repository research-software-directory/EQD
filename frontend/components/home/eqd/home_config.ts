...
export const home_config = {
  button: {
    ...
    register: {
      ...
      // MOVED to form
      // url: 'mailto:ariana.torres@surf.nl?subject=Register organisation',
      // target: '_blank'
    },
    demo: {
      label: 'Demo',
    ...
    github: {
      ...
      url: 'https://github.com/research-software-directory/EQD',
      target: '_blank'
    },
    contact: {
      label: 'Contact us',
      url: 'mailto:ariana.torres@surf.nl?subject=Question about EQD',
      target: '_blank'
    },
    news:{
      label: 'More news',
...
export const personalSignUp = {
  notification: [
    '* Required',
    'We will use your default email application to send an email to ariana.torres@surf.nl. Please send us an email directly if this fails.'
  ],
  name: {
    label: 'Your name *'
  },
