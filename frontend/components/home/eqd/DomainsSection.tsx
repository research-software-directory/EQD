  ...
  return (
    <section
      ...
      <h2 className="flex justify-center text-3xl lg:text-4xl font-rsd-titles font-bold"
        ...
        Discover the domain that is most relevant to you!
      </h2>
      ...
      <div
        ...
        >
          <GlowingButton
            text={button.fundamentalResearch.label}
            url={button.fundamentalResearch.url}
            target={button.fundamentalResearch.target}
            minWidth='19rem' />
        </div>
        ...
        >
          <GlowingButton
            text={button.integration.label}
            url={button.integration.url}
            target={button.integration.target}
            minWidth='19rem' />
        </div>
        ...
        >
          <GlowingButton
            text={button.applications.label}
            url={button.applications.url}
            target={button.applications.target}
            minWidth='19rem' />
        </div>
      </div>
    </section>
